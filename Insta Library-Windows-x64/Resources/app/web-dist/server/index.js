globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-COcioFqR.js","assets/layout-segment-context-B_DK_9i-.js"];
...
function getDraftSecret() {
	return "8614bfb9-0a8e-4d6e-ae07-f67ed95a2d89";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b8f86a77-a4da-42c9-81d4-045d73e366a0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b8f86a77-a4da-42c9-81d4-045d73e366a0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b8f86a77-a4da-42c9-81d4-045d73e366a0",
		rootBoundaryId
	});
}
/**
...
var __publicFiles = new Set([
	...
	"/fonts/OFL-Allura.txt",
	"/fonts/OFL-Geist.txt",
	"/fonts/geist-display-latin.woff2",
